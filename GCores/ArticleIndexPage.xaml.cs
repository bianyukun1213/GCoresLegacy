...
namespace GCores
{
    ...
    public sealed partial class ArticleIndexPage : Page
    {
        ...
        async void GetArticles(int pageNumber)
        {
            try
            {
                HttpClient hc = new HttpClient();
                HttpResponseMessage response = await hc.GetAsync(new Uri("http://www.g-cores.com/api/categories/1/originals?page=" + pageNumber + "&auth_exclusive=" + SplashPage.authExclusive));
